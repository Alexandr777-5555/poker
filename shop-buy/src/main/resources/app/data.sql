 ...
 insert into purchases (ID , BUY_DATE , CUSTOMER_ID) values (1 , '2020-03-05' , 1);
 insert into purchases (ID , BUY_DATE , CUSTOMER_ID) values (2 , '2020-03-08' , 2);
 insert into purchases (ID , BUY_DATE , CUSTOMER_ID) values (3 , '2020-03-14' , 3);